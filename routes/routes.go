...
func RegisterRoutes(server *gin.Engine) {
	...
	authenticated.POST("/events/:id/register", registerForEvent)     // POST /events/:id/register
	authenticated.DELETE("/events/:id/register", cancelRegistration) // DELETE /events/:id/register
